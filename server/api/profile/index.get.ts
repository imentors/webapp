        ...
        if (userRole === 'mentor') {
            ...
            if (mentorData) {
                profileData = {
                    ...
                    coreDomains: mentorData.coreDomains ? JSON.parse(mentorData.coreDomains) : [],
                    practicalExpertise: mentorData.practicalExpertise ? JSON.parse(mentorData.practicalExpertise) : [],
                    experienceContext: mentorData.experienceContext ? JSON.parse(mentorData.experienceContext) : [],
