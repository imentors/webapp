  ...
  try {
    ...
    const result = await db
      .select({
        ...
        coreDomains: mentorProfile.coreDomains,
        practicalExpertise: mentorProfile.practicalExpertise,
        experienceContext: mentorProfile.experienceContext,
    ...
    return {
      ...
      coreDomains: parseJsonArray(mentor.coreDomains),
      practicalExpertise: parseJsonArray(mentor.practicalExpertise),
      experienceContext: parseJsonArray(mentor.experienceContext),
